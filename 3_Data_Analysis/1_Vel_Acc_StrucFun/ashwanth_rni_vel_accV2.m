function [data, mean_data] = ashwanth_rni_vel_accV2(or3d, datapath, filterwidth, fitwidth, framerate, frame_range)
...
%    parfor_progress(0);
    ...
    or3d(ismember(or3d(:, 5), find(delete_index(1, :) == 1)), :) = []; % delete bad tracks
