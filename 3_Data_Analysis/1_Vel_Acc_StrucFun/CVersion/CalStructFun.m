function [statistics_struct, statistics_corr] = CalStructFun(dataset_path1, datapath, redges_lin, redges_log, save_name)
...
% end
data = read_gdf([dataset_path1 'velacc_velacc.gdf']); 
data(:,12:14) = read_gdf([dataset_path1 'velacc_velfluc.gdf']);
data(:, 4:5) = data(:, [5 4]);
