...
struct wrap_motstr_data_ {
  void   (*proj)(long int j, long int i, double *aj, double *bi, double *xij, void *adata); // Q
  void (*projac)(long int j, long int i, double *aj, double *bi, double *Aij, double *Bij, void *adata); // dQ/da, dQ/db
  long int cnp, pnp, mnp; /* parameter numbers */
  void *adata;
};

struct wrap_mot_data_ {
  void   (*proj)(long int j, long int i, double *aj, double *xij, void *adata); // Q
  void (*projac)(long int j, long int i, double *aj, double *Aij, void *adata); // dQ/da
  long int cnp, mnp; /* parameter numbers */
  void *adata;
};

struct wrap_str_data_ {
  void   (*proj)(long int j, long int i, double *bi, double *xij, void *adata); // Q
  void (*projac)(long int j, long int i, double *bi, double *Bij, void *adata); // dQ/db
  long int pnp, mnp; /* parameter numbers */
  void *adata;
};
 ...
 *
 */
static void sba_motstr_Qs(double *p, struct sba_crsm *idxij, long int *rcidxs, long int *rcsubs, double *hx, void *adata)
{
  ...
  void (*proj)(long int j, long int i, double *aj, double *bi, double *xij, void *proj_adata);
  void *proj_adata;
 ...
 *
 */
static void sba_motstr_Qs_jac(double *p, struct sba_crsm *idxij, long int *rcidxs, long int *rcsubs, double *jac, void *adata)
{
  register long int i, j;
  long int cnp, pnp, mnp;
  double *pa, *pb, *paj, *pbi, *pAij, *pBij;
  long int n, m, nnz, Asz, Bsz, ABsz, idx;
  struct wrap_motstr_data_ *wdata;
  void (*projac)(long int j, long int i, double *aj, double *bi, double *Aij, double *Bij, void *projac_adata);
  void *projac_adata;
 ...
 *
 */
static void sba_mot_Qs(double *p, struct sba_crsm *idxij, long int *rcidxs, long int *rcsubs, double *hx, void *adata)
{
  register long int i, j;
  long int cnp, mnp; 
  double *paj, *pxij;
  ...
  void (*proj)(long int j, long int i, double *aj, double *xij, void *proj_adata);
  void *proj_adata;
 ...
 *
 */
static void sba_mot_Qs_jac(double *p, struct sba_crsm *idxij, long int *rcidxs, long int *rcsubs, double *jac, void *adata)
{
  register long int i, j;
  long int cnp, mnp;
  double *paj, *pAij;
  //long int n;
  long int m, nnz, Asz, idx;
  struct wrap_mot_data_ *wdata;
  void (*projac)(long int j, long int i, double *aj, double *Aij, void *projac_adata);
  void *projac_adata;
 ...
 *
 */
static void sba_str_Qs(double *p, struct sba_crsm *idxij, long int *rcidxs, long int *rcsubs, double *hx, void *adata)
{
  register long int i, j;
  long int pnp, mnp; 
  double *pbi, *pxij;
  ...
  void (*proj)(long int j, long int i, double *bi, double *xij, void *proj_adata);
  void *proj_adata;
 ...
 *
 */
static void sba_str_Qs_jac(double *p, struct sba_crsm *idxij, long int *rcidxs, long int *rcsubs, double *jac, void *adata)
{
  register long int i, j;
  long int pnp, mnp;
  double *pbi, *pBij;
  //long int n;
  long int m, nnz, Bsz, idx;
  struct wrap_str_data_ *wdata;
  void (*projac)(long int j, long int i, double *bi, double *Bij, void *projac_adata);
  void *projac_adata;
...
long int retval;
struct wrap_motstr_data_ wdata;
static void (*fjac)(double *p, struct sba_crsm *idxij, long int *rcidxs, long int *rcsubs, double *jac, void *adata);
