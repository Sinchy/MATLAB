function GenerateJobConfiguration_bubble(file_path)
...
txt = [ '/home/stan26/data_rni2/Code/OpenLPT_bubble/OpenLPT_Shake-The-Box/VisualStudio/ShakeTheBox/ShakeTheBox/Release/ShakeTheBox trackingconfig1.txt > result.txt << EOF\n' ...
'0\n' ...
'0\n' ...
'0\n' ...
'EOF\n' ];
