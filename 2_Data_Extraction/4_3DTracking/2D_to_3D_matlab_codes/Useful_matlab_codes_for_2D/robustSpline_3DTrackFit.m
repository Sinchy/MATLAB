function tracks_cluster = robustSpline_3DTrackFit(track3D_isolated, tr_images, tr1, tr2, tr3, tr4, camParaCalib, trck_minSize, cam, isFit)
clear Fit3D

    [a,b] = histc(track3D_isolated(:,4),unique(track3D_isolated(:,4)));
    y = a(b)>=trck_minSize;
...
while (rep <=1)
    ...
    if (numel(tReal > 0))
        ...
        tracks_cluster = tracks_clustering_and_fitting(track3D_isolated_rob);
