...
tracking_params.maxCost = 0.02; % max euclidean 3d-distance from predicted position to detected position
...
tracks = track_particles('./EXAMPLE/Coords3d/clustered/coords3d_%05d.dat', tracking_params);
