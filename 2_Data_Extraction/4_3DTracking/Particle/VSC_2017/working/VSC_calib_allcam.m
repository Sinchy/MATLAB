...
%direc='./cam1346/';
addpath '../';
fixcamera=[1,2,3]; % which camera is fixed. fixcamera=[1,4]; camera 1 and 4 are fixed. fixcamera=[]; all camera can be changed. 
...
load ([direc 'data.mat']);
load ([direc 'camParaCalib.mat']);
%load ([direc 'VSC_1234.mat']);
camParaCalib = camParaCalib([1,3,4,6]);
