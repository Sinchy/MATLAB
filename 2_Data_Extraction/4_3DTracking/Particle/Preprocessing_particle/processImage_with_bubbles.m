...
%% Inputs
dirr = ':/home-4/stan26@jhu.edu/data/07.25.18/Run1_11_of_88_3s_Jet2/';
save_dir = '/home-4/stan26@jhu.edu/data/07.25.18/Run1_11_of_88_3s_Jet2/';
...
threshold = [0.45; 0.45; 0.37; 0.40; 0.18; 0.21];
%% processing
for cam = 1:4
    camdir = [dirr 'C00' num2str(cam) '_H001S0001/'];
    for I = totalImgs:-1:199
