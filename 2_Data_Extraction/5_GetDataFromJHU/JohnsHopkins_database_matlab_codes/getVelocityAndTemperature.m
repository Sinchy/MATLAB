...
function result = getVelocityAndTemperature(authToken, dataset, time, spatialInterpolation, ...
...
resultStruct =  GetVelocityAndTemperature (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);

result = getVector(resultStruct.GetVelocityAndTemperatureResult.Vector3P);
