...
function result = getTemperature(authToken, dataset, time, ...
...
resultStruct =  GetTemperature (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);

result = getVector(resultStruct.GetTemperatureResult.Pressure);
