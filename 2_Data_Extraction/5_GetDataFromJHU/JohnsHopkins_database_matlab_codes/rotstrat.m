...
% 2017: Modified by Zhao Wu and Rohit Ravoori, adding getInvariant and isotropic4096 commentsâ€?
...
result4 = getVelocityAndPressure (authkey, dataset, snapshot, Lag6, NoTInt, npoints, points);
for p = 1:npoints
...
threshold_array =  getThreshold (authkey, dataset, threshold_field, snapshot, threshold, NoSInt, X, Y, Z, Xwidth, Ywidth, Zwidth);
