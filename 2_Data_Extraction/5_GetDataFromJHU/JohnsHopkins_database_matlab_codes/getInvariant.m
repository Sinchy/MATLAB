...
function result = getInvariant(authToken, dataset, time, spatialInterpolation, ...
...
resultStruct =  GetInvariant (obj, authToken, dataset, time, ...
		spatialInterpolation, ...
		temporalInterpolation, ...
		points);
    
result = getVector(resultStruct.GetInvariantResult.Vector3);
result = result(1:2,:);
return
